            ...
            <form action="{{route('news.update',$data->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  @if($data->image)
                  <img src="{{ URL::asset('/admin/uploads/news_image/'.$data->image)}}" style="width:50px;height:50px;border-radius:50%;border:1px solid#ddd;">
                  @endif
                ...
                <div class="form-group">
                  ...
                  <span style="color: red;" class="star">*</span>
                  <input type="text" class="form-control" name="read_more_link"  value="{{isset($data->read_more_link)?$data->read_more_link:""}}">
                  <span class="text-danger"> @error('date'){{$message}} @enderror</span>
                </div>
                <div class="form-group">
